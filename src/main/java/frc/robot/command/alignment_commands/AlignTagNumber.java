...
public class AlignTagNumber extends Command {
    ...
    public void initialize() {
        latestTagData = AprilTagSubsystem.GetTagById(tagNumber).get();
    ...
    public boolean isFinished() {
        return withinThreshold(latestTagData.pose2d.getRotation().getDegrees(), 6.0)
                && withinThreshold(latestTagData.pose2d.getTranslation().getNorm(), 0.1);
    }
